...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Editar Tipo de Póliza</h3>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        {!! Form::model($tipopoliza, ['method' => 'PATCH','route' => ['tipopolizas.update', $tipopoliza->COD_TIP_POLIZA]]) !!}
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('IND_TIP_POLIZA', ['A' => 'Activo', 'I' => 'Inactivo']) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
